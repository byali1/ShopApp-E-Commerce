...
namespace ShopApp.WebUI.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult DeleteItemFromCart(int productId)
        {
            ...
            _cartService.DeleteItemFromCart(_userManager.GetUserId(User), productId);
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-HRRSTKpAlKkmdeZ6r8o0sEoxqttlUrm4";
            options.SecretKey = "sandbox-YYJB2OQ6s8fSvvMiHnfdRkYWwAR3IzjW";
